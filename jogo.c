...
static SN_BITMAP sprites[11]; /* Imagens da pontuação */
...
static void sn_jogo_posicionar_comida(){
    ...
    do{
        ...
        /* Verifica se nova posição não colide com a cobra */
        for(i = 0 ; i < cobra_tam ; i++){
...
/* Limpa recursos alocados no início */
...
void sn_jogo_run(){
    ...
    while(!morreu){
        ...
        /* Se passou o tempo ou mudou de direção */
